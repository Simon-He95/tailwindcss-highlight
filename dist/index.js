...
var defaultUtilitiesConfig = {
  ...
  pointer: {
    regex: "(?<=[:`'\"\\s])!?pointer-events-(none|auto)",
    color: "rgba(171, 169, 169, 1)"
  },
  blur: {
    regex: "(?<=[:`'\"\\s])!?blur(-(none|sm|md|lg|xl|2xl|3xl))?",
    color: "rgba(171, 169, 169, 1)"
  },
  brightness: {
    regex: "(?<=[:`'\"\\s])!?brightness-[0-9]+",
    color: "rgba(171, 169, 169, 1)"
  },
  contrast: {
    regex: "(?<=[:`'\"\\s])!?contrast-[0-9]+",
    color: "rgba(171, 169, 169, 1)"
  },
  grayscale: {
    regex: "(?<=[:`'\"\\s])!?grayscale(-0)?",
  ...
  select: {
    regex: "(?<=[:`'\"\\s])!?select-(none|text|all|auto)",
